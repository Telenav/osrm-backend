...
type ID2NearByIDsMap map[entity.PlaceID][]*entity.RankedPlaceInfo
...
func (cm *ConnectivityMap) Build(iterator place.PlacesIterator, finder place.Finder,
	ranker place.Ranker, numOfWorkers int) *ConnectivityMap {
...
func (cm *ConnectivityMap) QueryConnectivity(placeID entity.PlaceID) ([]*entity.RankedPlaceInfo, bool) {
