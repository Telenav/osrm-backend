...
$ helm install osrm-backend --generate-name -n osrm --set osrm.backend.image=telenavmap/osrm-backend-within-mapdata:no.86-20200114-master-telenav-e85d5ca-compile28-20200119T171422CST-nevada-latest
...
$ helm list -n osrm
NAME                    NAMESPACE       REVISION        UPDATED                                 STATUS          CHART                   APP VERSION
osrm-backend-1579678916 osrm    1               2020-01-21 23:41:56.694024666 -0800 PST deployed        osrm-backend-0.4.0
$ 
$ # get service for this osrm-backend installation
$ kubectl get svc -n osrm | grep osrm-backend-1579678916
...
$ helm install osrm-frontend --generate-name -n osrm --set osrm.frontend.targetBackend='http://internal-aaa74ad603cea11ea82ff0268b6e6a1a-222618767.us-west-2.elb.amazonaws.com:5000',osrm.frontend.center='36.122314\,-115.111110'
$ 
$ # see the deployed osrm-frontend
$ helm list -n osrm
NAME                            NAMESPACE       REVISION        UPDATED                                 STATUS          CHART                   APP VERSION
osrm-backend-1579678916         osrm    1               2020-01-21 23:41:56.694024666 -0800 PST deployed        osrm-backend-0.4.0
osrm-frontend-1579679580        osrm    1               2020-01-21 23:53:00.988146482 -0800 PST deployed        osrm-frontend-0.4.0
$ 
$ # get service for this osrm-frontend installation
$ kubectl get svc -n osrm | grep osrm-frontend-1579679580
...
$ 
$ # uninstall after use
$ helm uninstall osrm-frontend-1579679580 -n osrm
$ helm uninstall osrm-backend-1579678916 -n osrm
```